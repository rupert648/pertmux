...
- **coding_agent/mod.rs**: Defines the `CodingAgent` trait and `agents_from_config()` factory. Currently only opencode is supported. To add a new agent, implement the trait and register it here.
